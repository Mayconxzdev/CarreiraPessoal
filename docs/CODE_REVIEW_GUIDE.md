...
O módulo separa cargos/famílias priorizadas, sinais adjacentes e exclusões. A decisão é determinística e continua funcionando sem IA generativa.
...
Esses documentos explicam por que o núcleo é local-first, por que recursos pesados são opcionais, por que o envio final é manual e como a edição pública foi separada do workspace pessoal.
...
O objetivo deste guia é reduzir o tempo de quem estiver avaliando o projeto: arquitetura, código representativo, decisões e limites ficam explícitos sem exigir que a pessoa procure o que vale abrir.
